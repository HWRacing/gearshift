...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "D:/fpga/intel/quartus/"
}
...
ensure_lib                                           ./libraries/modular_adc_0_sample_store_csr_agent/     
vmap       modular_adc_0_sample_store_csr_agent      ./libraries/modular_adc_0_sample_store_csr_agent/     
ensure_lib                                           ./libraries/master_0_master_agent/                    
vmap       master_0_master_agent                     ./libraries/master_0_master_agent/                    
ensure_lib                                           ./libraries/modular_adc_0_sample_store_csr_translator/
vmap       modular_adc_0_sample_store_csr_translator ./libraries/modular_adc_0_sample_store_csr_translator/
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADCTestADC_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv" -work error_adapter_0                          
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/ADCTestADC_mm_interconnect_0_avalon_st_adapter.v"                  -work avalon_st_adapter                        
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADCTestADC_mm_interconnect_0_rsp_mux.sv"                           -work rsp_mux                                  
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                       -work rsp_mux                                  
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADCTestADC_mm_interconnect_0_rsp_demux.sv"                         -work rsp_demux                                
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADCTestADC_mm_interconnect_0_cmd_mux.sv"                           -work cmd_mux                                  
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                       -work cmd_mux                                  
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADCTestADC_mm_interconnect_0_cmd_demux.sv"                         -work cmd_demux                                
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                                  -work master_0_master_limiter                  
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                                   -work master_0_master_limiter                  
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                           -work master_0_master_limiter                  
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                  -work master_0_master_limiter                  
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADCTestADC_mm_interconnect_0_router_001.sv"                        -work router_001                               
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADCTestADC_mm_interconnect_0_router.sv"                            -work router                                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                      -work modular_adc_0_sample_store_csr_agent     
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                               -work modular_adc_0_sample_store_csr_agent     
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                     -work master_0_master_agent                    
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                 -work modular_adc_0_sample_store_csr_translator
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                -work master_0_master_translator               
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADCTestADC_master_0_p2b_adapter.sv"                                -work p2b_adapter                              
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADCTestADC_master_0_b2p_adapter.sv"                                -work b2p_adapter                              
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADCTestADC_master_0_timing_adt.sv"                                 -work timing_adt                               
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/ADCTestADC_mm_interconnect_0.v"                                    -work mm_interconnect_0                        
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/ADCTestADC_modular_adc_0.v"                                        -work modular_adc_0                            
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/ADCTestADC_master_0.v"                                             -work master_0                                 
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/ADCTestADC_altpll_0.vo"                                            -work altpll_0                                 
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/ADCTestADC.v"                                                                                                                
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L error_adapter_0 -L avalon_st_adapter -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L master_0_master_limiter -L router_001 -L router -L modular_adc_0_sample_store_csr_agent -L master_0_master_agent -L modular_adc_0_sample_store_csr_translator -L master_0_master_translator -L sample_store_internal -L sequencer_internal -L control_internal -L p2b_adapter -L b2p_adapter -L transacto -L p2b -L b2p -L fifo -L timing_adt -L jtag_phy_embedded_in_jtag_master -L rst_controller -L mm_interconnect_0 -L modular_adc_0 -L master_0 -L altpll_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver $TOP_LEVEL_NAME
}
