// ADCTestADC_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module ADCTestADC_mm_interconnect_0 (
	...
	ADCTestADC_mm_interconnect_0_router router (
	...
	ADCTestADC_mm_interconnect_0_router_001 router_001 (
	...
	ADCTestADC_mm_interconnect_0_router_001 router_002 (
	...
	ADCTestADC_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                        //        clk.clk
		.reset              (modular_adc_0_reset_sink_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	ADCTestADC_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                        //       clk.clk
		.reset               (modular_adc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ADCTestADC_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                        //       clk.clk
		.reset               (modular_adc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ADCTestADC_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                        //       clk.clk
		.reset              (modular_adc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ADCTestADC_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                        //       clk.clk
		.reset              (modular_adc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ADCTestADC_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                        //       clk.clk
		.reset               (modular_adc_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ADCTestADC_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
